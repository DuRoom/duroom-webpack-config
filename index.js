...
module.exports = function (options = {}) {
  return {
    ...
    externals: [
      {
        '@duroom/core/forum': 'duroom.core',
        '@duroom/core/admin': 'duroom.core',
        jquery: 'jQuery',
      },
      ...
      function ({request}, callback) {
        let matches;
        if ((matches = /^duroom\/(.+)$/.exec(request))) {
          return callback(null, "root duroom.core.compat['" + matches[1] + "']");
        }
        callback();
      },
    ],
